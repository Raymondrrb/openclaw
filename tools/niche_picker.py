...
NICHE_POOL: list[NicheCandidate] = [
    # Audio
    NicheCandidate("wireless earbuds", "audio", subcategory="true wireless earbuds", intent="general", price_band="mid", price_min=120, price_max=350, review_coverage=5, amazon_depth=5, monetization=4),
    NicheCandidate("over-ear headphones", "audio", subcategory="over-ear headphones", intent="general", price_band="premium", price_min=120, price_max=500, review_coverage=5, amazon_depth=5, monetization=5),
    NicheCandidate("noise cancelling headphones", "audio", subcategory="active noise cancelling headphones", intent="travel", price_band="premium", price_min=120, price_max=450, review_coverage=5, amazon_depth=5, monetization=5),
    NicheCandidate("portable bluetooth speakers", "audio", subcategory="portable bluetooth speakers", intent="general", price_band="mid", price_min=120, price_max=300, review_coverage=5, amazon_depth=5, monetization=4),
    NicheCandidate("soundbars", "audio", subcategory="soundbars", intent="general", price_band="premium", price_min=120, price_max=500, review_coverage=5, amazon_depth=4, monetization=5),
    ...
    NicheCandidate("podcast microphones", "audio", subcategory="podcast microphones", intent="creative", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=4, monetization=4),
    NicheCandidate("USB microphones", "audio", subcategory="USB condenser microphones", intent="creative", price_band="mid", price_min=120, price_max=250, review_coverage=4, amazon_depth=4, monetization=4),
    NicheCandidate("gaming headsets", "audio", subcategory="gaming headsets", intent="gaming", price_band="mid", price_min=120, price_max=300, review_coverage=5, amazon_depth=5, monetization=4),
    NicheCandidate("turntables", "audio", subcategory="turntables", intent="general", price_band="premium", price_min=120, price_max=500, review_coverage=4, amazon_depth=3, monetization=4),
    NicheCandidate("bookshelf speakers", "audio", subcategory="bookshelf speakers", intent="general", price_band="premium", price_min=120, price_max=500, review_coverage=4, amazon_depth=4, monetization=4),

    # Computing / peripherals
    NicheCandidate("mechanical keyboards", "computing", subcategory="mechanical keyboards", intent="general", price_band="mid", price_min=120, price_max=300, review_coverage=5, amazon_depth=5, monetization=4),
    NicheCandidate("ergonomic keyboards", "computing", subcategory="ergonomic keyboards", intent="work", price_band="mid", price_min=120, price_max=250, review_coverage=4, amazon_depth=4, monetization=4),
    NicheCandidate("wireless mice", "computing", subcategory="wireless mice", intent="work", price_band="mid", price_min=100, price_max=150, review_coverage=4, amazon_depth=5, monetization=3),
    NicheCandidate("gaming mice", "computing", subcategory="gaming mice", intent="gaming", price_band="mid", price_min=100, price_max=180, review_coverage=5, amazon_depth=5, monetization=3),
    NicheCandidate("webcams", "computing", subcategory="webcams", intent="work", price_band="mid", price_min=100, price_max=200, review_coverage=4, amazon_depth=4, monetization=4),
    ...
    NicheCandidate("external SSDs", "computing", subcategory="portable external SSDs", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=5, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("air purifiers", "home", subcategory="air purifiers", intent="general", price_band="mid", price_min=120, price_max=400, review_coverage=5, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("smart thermostats", "home", subcategory="smart thermostats", intent="general", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=3, monetization=4),
    NicheCandidate("smart locks", "home", subcategory="smart locks", intent="general", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=4, monetization=4),
    NicheCandidate("video doorbells", "home", subcategory="video doorbells", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=5, amazon_depth=4, monetization=4),
    ...
    NicheCandidate("wifi routers", "home", subcategory="wifi routers", intent="general", price_band="mid", price_min=120, price_max=350, review_coverage=5, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("electric toothbrushes", "home", subcategory="electric toothbrushes", intent="general", price_band="mid", price_min=100, price_max=200, review_coverage=4, amazon_depth=5, monetization=3),
    NicheCandidate("electric shavers", "home", subcategory="electric shavers", intent="general", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=4, monetization=4),
    ...
    # Kitchen
    NicheCandidate("air fryers", "kitchen", subcategory="air fryers", intent="general", price_band="mid", price_min=100, price_max=200, review_coverage=5, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("coffee grinders", "kitchen", subcategory="coffee grinders", intent="general", price_band="mid", price_min=100, price_max=200, review_coverage=4, amazon_depth=4, monetization=3),
    NicheCandidate("drip coffee makers", "kitchen", subcategory="drip coffee makers", intent="general", price_band="mid", price_min=100, price_max=200, review_coverage=4, amazon_depth=5, monetization=3),
    NicheCandidate("blenders", "kitchen", subcategory="blenders", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=4, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("food processors", "kitchen", subcategory="food processors", intent="general", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=4, monetization=4),
    ...
    NicheCandidate("toaster ovens", "kitchen", subcategory="toaster ovens", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=4, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("sous vide machines", "kitchen", subcategory="sous vide cookers", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=3, amazon_depth=4, monetization=4),
    NicheCandidate("knife sets", "kitchen", subcategory="kitchen knife sets", intent="general", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("nonstick cookware sets", "kitchen", subcategory="nonstick cookware sets", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=4, amazon_depth=5, monetization=4),
    ...
    # Fitness / outdoor
    NicheCandidate("fitness trackers", "fitness", subcategory="fitness trackers", intent="fitness", price_band="mid", price_min=100, price_max=200, review_coverage=5, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("running shoes", "fitness", subcategory="running shoes", intent="fitness", price_band="mid", price_min=100, price_max=200, review_coverage=4, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("cycling helmets", "fitness", subcategory="cycling helmets", intent="fitness", price_band="mid", price_min=100, price_max=200, review_coverage=3, amazon_depth=4, monetization=3),
    NicheCandidate("hiking boots", "fitness", subcategory="hiking boots", intent="fitness", price_band="mid", price_min=120, price_max=250, review_coverage=4, amazon_depth=4, monetization=4),
    NicheCandidate("camping tents", "outdoor", subcategory="camping tents", intent="travel", price_band="mid", price_min=120, price_max=400, review_coverage=4, amazon_depth=4, monetization=4),
    NicheCandidate("sleeping bags", "outdoor", subcategory="sleeping bags", intent="travel", price_band="mid", price_min=100, price_max=200, review_coverage=3, amazon_depth=4, monetization=3),

    # Travel / EDC
    NicheCandidate("carry on luggage", "travel", subcategory="carry-on suitcase", intent="travel", price_band="premium", price_min=120, price_max=400, review_coverage=5, amazon_depth=5, monetization=5),
    NicheCandidate("travel backpacks", "travel", subcategory="travel backpacks", intent="travel", price_band="mid", price_min=100, price_max=200, review_coverage=4, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("noise cancelling earbuds for travel", "travel", subcategory="travel earbuds", intent="travel", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=4, monetization=4),
    ...
    NicheCandidate("dash cams", "camera", subcategory="dash cams", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=5, amazon_depth=5, monetization=4),
    ...
    # Gaming
    NicheCandidate("gaming keyboards", "gaming", subcategory="gaming keyboards", intent="gaming", price_band="mid", price_min=120, price_max=200, review_coverage=5, amazon_depth=5, monetization=4),
    ...
    NicheCandidate("game capture cards", "gaming", subcategory="game capture cards", intent="gaming", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=3, monetization=4),
    NicheCandidate("gaming controllers", "gaming", subcategory="gaming controllers", intent="gaming", price_band="mid", price_min=100, price_max=200, review_coverage=4, amazon_depth=5, monetization=3),
    ...
    # Streaming / content
    NicheCandidate("streaming microphones", "streaming", subcategory="streaming microphones", intent="creative", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=4, monetization=4),
    NicheCandidate("stream decks", "streaming", subcategory="stream decks", intent="creative", price_band="mid", price_min=120, price_max=250, review_coverage=3, amazon_depth=3, monetization=4),
    ...
    NicheCandidate("studio headphones", "streaming", subcategory="studio headphones", intent="creative", price_band="mid", price_min=120, price_max=300, review_coverage=4, amazon_depth=4, monetization=4),

    # Baby / kids (high conversion)
    NicheCandidate("baby monitors", "baby", subcategory="baby monitors", intent="general", price_band="mid", price_min=120, price_max=250, review_coverage=4, amazon_depth=5, monetization=4),

...
# --- FFmpeg render (segmented video assembler) ---
render:
	caffeinate -dimsu python3 -m rayvault.ffmpeg_render --run-dir state/runs/$(RUN_ID)

render-apply:
	caffeinate -dimsu python3 -m rayvault.ffmpeg_render --run-dir state/runs/$(RUN_ID) --apply
